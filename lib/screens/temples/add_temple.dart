...
class AddTemples extends StatelessWidget {
  AddTemples({Key? key}) : super(key: key);
  ...
  //customerId, deviceRegistrationId, templeId, templeType
  // templeName, templeLocalName, templeLocation, templeCity
  // templeState, country, zipCode, templeLocalId
  // templeImage,  imageCourtesy, templeDescription, mainDeity
  // otherDeities, openingTime, festivals, mainOfferings
  // contactPhone, latitude
                            ...
                            step.value == 1
                                ? Column(
                                    ...
                                    children: [
                                      ...
                                      provider.selectedImage != null
                                          ...
                                          : provider.editDest && provider.templeImage != null
                                              ? Stack(
                                                  alignment: Alignment.topRight,
                                                  children: [
                                                    Padding(
                                ...
                                : Column(
                                    ...
                                    children: [
                                        ...
                                        children: [
                                          Container(
                                            child: provider.selectedImage1 !=
                                                ...
                                                : provider.editDest &&
                                                        provider.templeImage1!.isNotEmpty
                                                    ? Stack(
                                                        alignment:
                                                            Alignment.topRight,
                                                        children: [
                                          ...
                                          Container(
                                            child: provider.selectedImage2 !=
                                                ...
                                                : provider.editDest &&
                                                        provider.templeImage2!.isNotEmpty
                                                    ? Stack(
                                                        alignment:
                                                            Alignment.topRight,
                                                        children: [
                                          ...
                                          Container(
                                            child: provider.selectedImage3 !=
                                                ...
                                                : provider.editDest &&
                                                        provider.templeImage3!.isNotEmpty
                                                    ? Stack(
                                                        alignment:
                                                            Alignment.topRight,
                                                        children: [
                                          ...
                                          Container(
                                            child: provider.selectedImage4 !=
                                                ...
                                                : provider.editDest &&
                                                        provider.templeImage4!.isNotEmpty
                                                    ? Stack(
                                                        alignment:
                                                            Alignment.topRight,
                                                        children: [
                                      ...
                                      CommonHeadTile(
                                        title: "Destination Attraction (Optional)",
                                      ),
                                      const SizedBox(
                                        height: 8,
                                      ),
                                    ...
                                    ontap: () {
                                      if (step.value == 1) {
                                        ...
                                        if (provider
                                          ...
                                          if(provider.editDest){
                                            provider.editDestination(context: context);
                                          }else{
                                            provider.addDestination(context: context);
                                          }
                                        }
                                      }
                                    },
