...
class NearMe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomBarUI(context,1),
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,
      floatingActionButton: FloatingButton(context, 1),
            ...
            child: SingleChildScrollView(
              ...
              child:  Column(
                children: [
                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (val) {
                                if(val.length >= 2){
                                  provider.getNearestDestinationsSearch(context: context);
                                }
                              },
                  ...
                  provider.nearDestinationList != null ? Container(
                    child: provider.nearDestinationList!.result!.isNotEmpty ? ListView.builder(
                        shrinkWrap: true,
                        physics: NeverScrollableScrollPhysics(),
                        padding: EdgeInsets.only(bottom: provider.showMoreTemple2 && provider.showMoreTempleLoader2 ? 0 : 70),
                        itemCount: provider.nearDestinationList!.result!.length,
                        itemBuilder: (context, index) {
                          return TempleTile(data: provider.nearDestinationList!.result![index],fromNear: true,);
                        }) :
                    Padding(
                  ...
                  provider.showMoreTemple2 && provider.showMoreTempleLoader2
                      ? Padding(
